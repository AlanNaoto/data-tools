...
if __name__ == "__main__":
    ...
    xml_dir_1 = '/media/alan/Seagate Expansion Drive/Data/Waymo/transformed_data/anns_bb_voc/train'
    xml_dir_2 = "/media/alan/Seagate Expansion Drive/Data/Waymo/transformed_data/anns_bb_voc/val"
    json_file_train = "results/waymo_shuffle_holdout_train.json"
    json_file_val = "results/waymo_shuffle_holdout_val.json"
    json_file_test = "results/waymo_shuffle_holdout_test.json"
    train_split = 0.80
    val_split = 0.10
    test_split = 0.10
